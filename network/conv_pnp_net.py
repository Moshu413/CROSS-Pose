...
#from network.snake_conv import DSConv  # 或 DSConvAuto
from network.snake_conv_dual import SnakeConvBlock
from network.dsa import DSA
...
class MAPEncoder(nn.Module):
    def __init__(
        ...
        if FLAGS.use_dsa == 'dsa':
            conv_layer = nn.Conv2d
            print("MAPEncoder: Using DSA mode")
        elif FLAGS.use_dcn == 'dcnv3':
            conv_layer = DCNv3_C
            print("MAPEncoder: Using DCNv3 mode")
        else:
            assert FLAGS.use_dcn == ''
            conv_layer = nn.Conv2d
            print("MAPEncoder: Using standard Conv2d mode")
